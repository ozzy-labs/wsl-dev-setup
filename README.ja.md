...
- 🤖 **AI 開発ツール対応** - Claude Code, Codex CLI, GitHub Copilot CLI, Gemini CLI をサポート
...
8. **AIツール**
   ...
   - 各エージェントは固有の指示ファイル（`CLAUDE.md`, `AGENTS.md`, `.github/copilot-instructions.md`, `GEMINI.md`）を読み取り、共通の規約（コミットルール、ブランチ戦略、検証コマンド）を認識
9. **開発補助ツール**
   - **just** - タスクランナー
